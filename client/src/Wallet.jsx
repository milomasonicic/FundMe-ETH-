...
import abi from "./contract/support.json"
...
export default function Wallet() {
    ...
    async function connectWallet() {
        ...
        if(!connected) {
            ...
            const contractAddres = "0xD5BBC57933986EfD232416Dd8231002F5B53591C";
    ...
    return(
        <div className="max-w-[1200px] flex items-center justify-center mt-6 rounded-3xl h-[450px] mx-auto bg-gradient-to-r from-stone-50 via-neutral-100 via-white-150 to-stone-50">
           
            <div className="w-[92%] mt-5 bg-white rounded-3xl h-[350px] mx-auto flex flex-col items-center ">
                
                <button 
                onClick={connectWallet}
                className="mx-auto mt-8 text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 px-4 py-2 rounded-xl inline-flex items-center"
                type="button" 
              ...
              >
                ...
                {connected ? "Disonnect MetaMask" : "Connect with MetaMask" }
                ...
                <div className="mt-2">
                        ...
                        <div className="flex">
                            ...
                            <div className="mt-1">
                                <SiEthereum size={"1.2em"}></SiEthereum> 
                            </div>
                        </div>
                        : " "
                         }
